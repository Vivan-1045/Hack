    ...
    <div className="bg-gray-100 py-12">
      <section className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Easy Bill Splitting</h1>
          <p className="text-lg text-gray-600">
            Discover how our app simplifies bill splitting, making it easy to manage shared expenses with friends and family.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard
            ...
            description="Automatically calculate each person’s share of the bill, eliminating manual calculations and errors."
          />
          <FeatureCard
            ...
            title="Share Easily"
            description="Quickly add participants and split bills in just a few taps, ensuring everyone knows what they owe."
          />
          <FeatureCard
            ...
            description="Get real-time updates and notifications as bills are split and settled, keeping everyone informed."
          />
          <FeatureCard
